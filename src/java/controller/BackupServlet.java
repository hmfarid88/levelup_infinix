...
//compose message
        try {
            ...
            message.setSubject("Data Backup From  levelup_infinix");
                        
        MimeBodyPart messageBodyPart = new MimeBodyPart();
        Multipart multipart = new MimeMultipart();
       
        String file = "D:\\Level Up\\Backup File\\levelup_infinix.sql";
        
        String fileName = "levelup_infinix.sql";
        ...
        message.setContent(multipart);
            ...
            File f=new File("D:\\Level Up\\Backup File\\levelup_infinix.sql");
            f.delete();
